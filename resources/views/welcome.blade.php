...
<head>
    ...
    <title>Bolão da Depressão</title>
...
<h1 class="site-heading text-center text-white d-none d-lg-block">
    <span class="site-heading-upper text-primary mb-3">O melhor site bolão de todos os tempos</span>
    <span class="site-heading-lower">Bolão da Depressão</span>
</h1>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item active px-lg-4">
                    <a class="nav-link text-uppercase text-expanded" href="login">Entrar
